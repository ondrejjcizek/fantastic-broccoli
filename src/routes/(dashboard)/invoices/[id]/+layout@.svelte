<script lang="ts">
    ...
    import Arrow from '$components/Icon/Arrow.svelte';
...
<div
    class="h-full min-h-screen w-screen bg-whisper pt-16 pb-32 print:bg-transparent print:pt-0 print:pb-0 lg:pt-12"
>
