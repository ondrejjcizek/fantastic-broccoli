...
<div
    class="relative top-32 z-10 grid grid-cols-6 gap-x-5 gap-y-8 bg-white px-5 py-8 shadow-invoice print:top-0 print:py-0 print:shadow-none md:py-16 md:px-32"
>
    <div class="col-span-6 print:col-span-3 sm:col-span-3">
        <img src="/images/logo.png" srcset="/images/logo@2x.png 2x" alt="Compressed.fm" />
    </div>
